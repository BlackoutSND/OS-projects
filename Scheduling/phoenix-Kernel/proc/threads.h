...
typedef struct _thread_t {
	...
	int baseAge; //basePriority;   //Added parameter
	int age; //agingPriority;	//Added parameter
...
extern int proc_getThreadPriority();

extern int proc_getThreadAge();

extern int proc_setThreadBaseAge(int base);

extern int proc_getProcExecTime();

extern int proc_setProcExecTime(int time);

extern int proc_decrProcExecTime();
//the end of them
